...
@Getter
@Setter
public class WaterDeliveryOnRouteEvent extends ApplicationEvent {
    private Long deliveryId;
    private WaterDelivery delivery;
    public WaterDeliveryOnRouteEvent(Object source, Long deliveryId, WaterDelivery delivery) {
        super(source);
        this.deliveryId = deliveryId;
        this.delivery = delivery;
    }
    public WaterDeliveryOnRouteEvent(Object source,  WaterDelivery delivery) {
        super(source);
