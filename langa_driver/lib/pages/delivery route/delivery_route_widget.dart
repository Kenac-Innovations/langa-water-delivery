...
class _DeliveryRouteScreenState extends State<DeliveryRouteScreen> {
  ...
  // Static data for the delivery route
  final Delivery _delivery = const Delivery(
    deliverId: 301,
    priceAmount: 20.00,
    currency: 'USD',
    ...
    customer: Customer(
      ...
      emailAddress: 'orders@belgraviaretail.co.zw',
    ),
    isProposed: false,
    ...
    pickupContactName: 'Aqua-Pak',
    pickupContactPhone: '0242123456',
    dropOffContactName: 'Mr. Jones',
    dropOffContactPhone: '0777654321',
    packageWeight: 120,
  );

  final List<LatLng> _routeCoordinates = const [
    LatLng(-17.8639, 31.0274), // Pickup
    LatLng(-17.8500, 31.0300),
    LatLng(-17.8300, 31.0350),
    LatLng(-17.8048, 31.0366), // Dropoff
  ];

  final String _estimatedTime = '25 mins';
  final double _estimatedDistance = 8.5;
          ...
          SizedBox(
            ...
            child: GoogleMap(
              onMapCreated: (controller) {
                ...
                if (_routeCoordinates.isNotEmpty) {
                  Future.delayed(const Duration(milliseconds: 300), () {
                    _zoomToFitRoute(_routeCoordinates);
                  });
                }
              },
              markers: {
                Marker(
                  ...
                  infoWindow: InfoWindow(
                      title: 'Pickup', snippet: _delivery.pickupLocation),
                ),
                Marker(
                  ...
                  infoWindow: InfoWindow(
                      title: 'Dropoff', snippet: _delivery.dropOffLocation),
                ),
              },
              polylines: {
                Polyline(
              ...
              initialCameraPosition: CameraPosition(
                target: LatLng(
                  (_delivery.pickupLatitude + _delivery.dropOffLatitude) / 2,
                  (_delivery.pickupLongitude + _delivery.dropOffLongitude) / 2,
                ),
                zoom: 12,
              ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _buildInfoItem(
                          ...
                          label: 'Price',
                          value:
                              '\$${_delivery.priceAmount.toStringAsFixed(2)}',
                          iconColor: theme.primary,
                        ),
                      ],
                    ),
